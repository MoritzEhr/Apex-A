...
let searchQuery = "";
const SHOW_PRICE_BREAKDOWN = true;

const INCREASE_TOTAL_BY_5_PERCENT = false;

const SHOW_TRASH_ICON = true;
              ...
              <label>
                ...
                <div class="subscription-option-content">
                  ...
                  <p class="subscription-option-text">
                    Immer die <strong style="color: white";> schnellste Lieferung und exklusive Angebote erhalten!</strong><br>
